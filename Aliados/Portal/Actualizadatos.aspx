                ...
                <table id="TablaDatos">
                    ...
                    <tr>
                        <td class="CeldaTablaDatos">
                            <asp:Label ID="LblDoc" runat="server" Text="Documento:" /></td>
                        <td class="CeldaTablaDatos">
                            <asp:Label ID="TxtDoc" runat="server" /></td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                            <asp:Label ID="LblExp" runat="server" Text="Expedicion Documento:" /></td>
                        <td>
                            <asp:Label ID="TxtExp" runat="server" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LblFechNac" runat="server" Text="Fecha Nacimiento:" /></td>
                        <td>
                            <asp:TextBox ID="TxtFechNac" runat="server" Style="text-transform: uppercase" />
                            ...
                            <asp:CalendarExtender ID="TxtFechNac_CalendarExtender" runat="server" DefaultView="Days" Enabled="True" PopupPosition="BottomLeft" TargetControlID="TxtFechNac" CssClass="cal_Theme1" Format="yyyy/MM/dd" />
                        </td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                            <asp:Label ID="LblNombres" runat="server" Text="Nombres:" /></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="LblPrimerApellido" runat="server" Text="Primer apellido:" /></td>
                        <td>
                            <asp:TextBox ID="TxtPrimerApellido" runat="server" MaxLength="100" onkeypress="return ValidaSoloLetras(event)" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                            <asp:Label ID="LblSegundoApellido" runat="server" Text="Segundo apellido:" /></td>
                        <td>
                            <asp:TextBox ID="TxtSegundoApellido" runat="server" MaxLength="100" onkeypress="return ValidaSoloLetras(event)" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblSexoEmp" runat="server" Text="Sexo:" /></td>
                        <td>
                    ...
                    <tr class="ColorOscuro">
                        <td>
                            <asp:Label ID="LblLugarNac" runat="server" Text="Lugar Nacimiento:" /></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="LblEstCivil" runat="server" Text="Estado Civil:" /></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="LblBarrio" runat="server" Text="Barrio:" /></td>
                        <td>
                            <asp:TextBox ID="TxtBarrio" runat="server" MaxLength="45" onkeypress="return ValidaSoloLetras(event)" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                    ...
                    <tr class="ColorOscuro">
                        ...
                        <td>
                            <asp:TextBox ID="TxtEps" runat="server" MaxLength="50" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LblAfp" runat="server" Text="AFP:" /></td>
                        <td>
                            <asp:TextBox ID="TxtAfp" runat="server" MaxLength="50" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                            <asp:Label ID="LblCesantias" runat="server" Text="Fondo Cesantias:" /></td>
                        <td>
                            <asp:TextBox ID="TxtCesantias" runat="server" MaxLength="50" Style="text-transform: uppercase" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LblCorreo" runat="server" Text="Correo:" /></td>
                        <td>
                            <asp:TextBox ID="TxtCorreo" runat="server" MaxLength="100" /><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtCorreo" ErrorMessage="*Ingrese un correo válido" ForeColor="#CC3300" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"></asp:RegularExpressionValidator></td>
                    </tr>
                    <tr class="ColorOscuro">
                        <td>
                    ...
                    <tr class="ColorOscuro">
                        <td class="BotonTablaDatos">
                            <asp:Button ID="BtnEditar" runat="server" Text="Almacenar Información" ValidationGroup="form" OnClick="BtnEditar_Click" /></td>
                        <td class="BotonTablaDatos">
