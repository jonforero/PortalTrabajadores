        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    string command = "SELECT idTiposolicitud, Nombre_TipoSolicitud FROM basica_trabajador.TipoSolicitudes where TipoPortal = 'T' and Activo = 1 order by orden";
                    ...
                    try
                    {
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM basica_trabajador.Options_Menu WHERE url = 'Contactenos.aspx' AND idEmpresa = 'AE'", Conexion.ObtenerCnMysql());
