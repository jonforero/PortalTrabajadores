...
<asp:Content ID="Content2" ContentPlaceHolderID="Container" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:trabajadoresConnectionString %>" ProviderName="<%$ ConnectionStrings:trabajadoresConnectionString.ProviderName %>" SelectCommand="sp_numcomprobantesEmp" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="idEmpleado" SessionField="usuario" Type="String" />
                    <asp:SessionParameter Name="Etemporal"  Type="String" DefaultValue="AE" />
                </SelectParameters>
            </asp:SqlDataSource>
        </ContentTemplate>
        <Triggers>
