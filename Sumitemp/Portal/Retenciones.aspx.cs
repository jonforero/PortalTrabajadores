    ...
    public partial class Retenciones : System.Web.UI.Page
    {
        ...
        protected void ReportViewer1_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataSet2.formularioingresosretencionesDataTable dt = new DataSet2.formularioingresosretencionesDataTable();
                DataSet2TableAdapters.formularioingresosretencionesTableAdapter da = new DataSet2TableAdapters.formularioingresosretencionesTableAdapter();

                da.FillBy(dt,Session["usuario"].ToString(), "ST");
