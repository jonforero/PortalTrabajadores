    ...
    public partial class Visual : System.Web.UI.Page
    {
        ...
        public void generarCertificado(string id_Empleado)
        {
            ...
            try
            {
                ...
                string contents = File.ReadAllText(Server.MapPath("~/Html/SumiTemp.html"));
                ...
                iTextSharp.text.Image logo = iTextSharp.text.Image.GetInstance(Server.MapPath("~/Img/Sumitemp.jpg"));
                ...
                firma.SetAbsolutePosition(38, 270);
                document.Add(firma);
