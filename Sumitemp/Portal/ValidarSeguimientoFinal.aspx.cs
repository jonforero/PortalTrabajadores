    ...
    public partial class ValidarSeguimientoFinal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    try
                    {
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM " + bd1 + ".Options_Menu WHERE url = 'ValidarSeguimientoFinal.aspx'", Conexion.ObtenerCnMysql());
        ...
        protected void gvEmpleadosAsociados_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    gvObjetivosCreados.DataSource = dtDataTable;
                    this.CargarObservacionesEmpleado(idJefeEmpleado.ToString(), "4");
