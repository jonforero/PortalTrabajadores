        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    try
                    {
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM basica_trabajador.Options_Menu WHERE url = 'IngRetenciones.aspx' AND idEmpresa = 'ST'", Conexion.ObtenerCnMysql());
