    ...
    public partial class Visual : System.Web.UI.Page
    {
        ...
        public void generarCertificado(string id_Empleado)
        {
            ...
            try
            {
                ...
                string contents = File.ReadAllText(Server.MapPath("~/Html/SumiServis.html"));
                ...
                iTextSharp.text.Image logo = iTextSharp.text.Image.GetInstance(Server.MapPath("~/Img/Sumiservis.jpg"));
                ...
                {
                    contents = contents.Replace("[TIPO_CONTRATO]", "a término indefinido");
                }
                else
                {
                    contents = contents.Replace("[TIPO_CONTRATO]", "por el término que dure la realización de la obra o labor");
                }
                contents = contents.Replace("[OUTSOURCING]", reader["Descripcion_compania"].ToString());
